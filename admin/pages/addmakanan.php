<?php
    if(isset($_POST['simpan'])){
        ...
        if($uploadOk == 1){
            if($obj->addMakanan($_POST['fnama'],$_POST['fketerangan'],$target))
        {
                                    ...
                                    <form enctype="multipart/form-data" role="form" method="post" action="#">
                                        <fieldset disabled>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="disabledInput" type="text" placeholder="ID MAKANAN" disabled>
                                            </div>
                                        </fieldset>
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input name="fnama" min="4" max="50" class="form-control" placeholder="Masukkan Nama Makanan" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Keterangan</label>
                                            <textarea name="fketerangan" class="form-control" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Upload Gambar</label>
                                            <input type="file" name="ffoto"> Masukkan file gambar dengan 600px x 400px
                                        </div>
