                    ...
                    <div class="panel panel-default">
                      ...
                      ?>
                        <div class="panel-heading">
                            Data Makanan <?echo $nama;?> <a  class="btn btn-default" href="addmakanan.php"> <i class="fa fa-plus fa-fw"></i>Tambah Makanan</a>
                        </div>
                        <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                        ...
                                        <tr>
                                            <th colspan="2">
                                              <a  href="editmakanan.php?idmakanan=<?echo $id_makanan;?>" class="btn btn-default" > <i class="fa fa-edit fa-fw"></i>Edit Data</a> |
                                                    <button data-toggle="modal" data-target="#deleteThis<?echo $id_makanan;?>" style="background-color:;"  class="btn btn-default"><i class="fa fa-trash fa-fw"></i>Hapus Data</button>
