<?php
    if(isset($_GET['idmember'])){
        ...
        if($uploadOk == 1){
            if($obj->editMember($_POST['fnama'],$_POST['fusername'],$_POST['fpassword'],$_POST['fno'],$_POST['femail'],$_POST['falamat'],$target,$_POST['fid_member'])==true)
        {
            echo "<script>alert('edit berhasil!'); document.location=('member.php');</script>";
                                    ...
                                    <form enctype="multipart/form-data" role="form" method="post" action="#">
                                        <fieldset disabled>
                                            <div class="form-group">
                                                ...
                                                <input value="<?echo $id_member;?>" class="form-control" id="disabledInput" type="text" placeholder="ID MEMBER" disabled >
                                            </div>
                                        </fieldset>
                                        <div class="form-group">
                                            <label>Nama</label>
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea  name="falamat" class="form-control" rows="3"><? echo $alamat;?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Upload Gambar</label>
                                            <input type="file" name="ffoto">
                                            <input type="hidden" name="fotolama" value="<?echo $foto;?>"> 
                                            <input type="hidden"  name="fid_member" value="<?echo $id_member;?>">
...
{
    echo "<script>alert('no id selected!'); document.location=('member.php');</script>";
